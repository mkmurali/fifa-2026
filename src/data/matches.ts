...
export const matches: Match[] = [
  ...
  // --- Group A ---
  { id: "a1", round: "Group Stage", group: "A", homeTeam: "mexico", awayTeam: "south-africa", date: J(11), time: "13:00", venue: "azteca", status: "scheduled" },
  { id: "a2", round: "Group Stage", group: "A", homeTeam: "south-korea", awayTeam: "czechia", date: J(11), time: "20:00", venue: "akron", status: "scheduled" },
  { id: "a3", round: "Group Stage", group: "A", homeTeam: "czechia", awayTeam: "south-africa", date: J(18), time: "12:00", venue: "mercedes", status: "scheduled" },
  { id: "a4", round: "Group Stage", group: "A", homeTeam: "mexico", awayTeam: "south-korea", date: J(18), time: "19:00", venue: "akron", status: "scheduled" },
  { id: "a5", round: "Group Stage", group: "A", homeTeam: "czechia", awayTeam: "mexico", date: J(24), time: "19:00", venue: "azteca", status: "scheduled" },
  { id: "a6", round: "Group Stage", group: "A", homeTeam: "south-africa", awayTeam: "south-korea", date: J(24), time: "19:00", venue: "bbva", status: "scheduled" },

  // --- Group B ---
  { id: "b1", round: "Group Stage", group: "B", homeTeam: "canada", awayTeam: "bosnia", date: J(12), time: "15:00", venue: "bmofield", status: "scheduled" },
  { id: "b2", round: "Group Stage", group: "B", homeTeam: "qatar", awayTeam: "switzerland", date: J(13), time: "12:00", venue: "levis", status: "scheduled" },
  { id: "b3", round: "Group Stage", group: "B", homeTeam: "switzerland", awayTeam: "bosnia", date: J(18), time: "12:00", venue: "sofi", status: "scheduled" },
  { id: "b4", round: "Group Stage", group: "B", homeTeam: "canada", awayTeam: "qatar", date: J(18), time: "15:00", venue: "bcplace", status: "scheduled" },
  { id: "b5", round: "Group Stage", group: "B", homeTeam: "switzerland", awayTeam: "canada", date: J(24), time: "12:00", venue: "bcplace", status: "scheduled" },
  { id: "b6", round: "Group Stage", group: "B", homeTeam: "bosnia", awayTeam: "qatar", date: J(24), time: "12:00", venue: "lumen", status: "scheduled" },

  // --- Group C ---
  { id: "c1", round: "Group Stage", group: "C", homeTeam: "brazil", awayTeam: "morocco", date: J(13), time: "18:00", venue: "metlife", status: "scheduled" },
  { id: "c2", round: "Group Stage", group: "C", homeTeam: "haiti", awayTeam: "scotland", date: J(13), time: "21:00", venue: "gillette", status: "scheduled" },
  { id: "c3", round: "Group Stage", group: "C", homeTeam: "scotland", awayTeam: "morocco", date: J(19), time: "18:00", venue: "gillette", status: "scheduled" },
  { id: "c4", round: "Group Stage", group: "C", homeTeam: "brazil", awayTeam: "haiti", date: J(19), time: "21:00", venue: "linc", status: "scheduled" },
  { id: "c5", round: "Group Stage", group: "C", homeTeam: "scotland", awayTeam: "brazil", date: J(24), time: "18:00", venue: "hardrock", status: "scheduled" },
  { id: "c6", round: "Group Stage", group: "C", homeTeam: "morocco", awayTeam: "haiti", date: J(24), time: "18:00", venue: "mercedes", status: "scheduled" },

  // --- Group D ---
  { id: "d1", round: "Group Stage", group: "D", homeTeam: "usa", awayTeam: "paraguay", date: J(12), time: "18:00", venue: "sofi", status: "scheduled" },
  { id: "d2", round: "Group Stage", group: "D", homeTeam: "australia", awayTeam: "turkiye", date: J(13), time: "21:00", venue: "bcplace", status: "scheduled" },
  { id: "d3", round: "Group Stage", group: "D", homeTeam: "turkiye", awayTeam: "paraguay", date: J(19), time: "19:00", venue: "levis", status: "scheduled" },
  { id: "d4", round: "Group Stage", group: "D", homeTeam: "usa", awayTeam: "australia", date: J(19), time: "16:00", venue: "lumen", status: "scheduled" },
  { id: "d5", round: "Group Stage", group: "D", homeTeam: "turkiye", awayTeam: "usa", date: J(24), time: "21:00", venue: "sofi", status: "scheduled" },
  { id: "d6", round: "Group Stage", group: "D", homeTeam: "paraguay", awayTeam: "australia", date: J(24), time: "21:00", venue: "levis", status: "scheduled" },

  // --- Group E ---
  { id: "e1", round: "Group Stage", group: "E", homeTeam: "germany", awayTeam: "curacao", date: J(14), time: "13:00", venue: "nrg", status: "scheduled" },
  ...
  { id: "e4", round: "Group Stage", group: "E", homeTeam: "ecuador", awayTeam: "curacao", date: J(20), time: "19:00", venue: "arrowhead", status: "scheduled" },
  ...
  // --- Group F ---
  { id: "f1", round: "Group Stage", group: "F", homeTeam: "netherlands", awayTeam: "japan", date: J(14), time: "17:00", venue: "att", status: "scheduled" },
  { id: "f2", round: "Group Stage", group: "F", homeTeam: "sweden", awayTeam: "tunisia", date: J(14), time: "20:00", venue: "bbva", status: "scheduled" },
  { id: "f3", round: "Group Stage", group: "F", homeTeam: "netherlands", awayTeam: "sweden", date: J(20), time: "14:00", venue: "nrg", status: "scheduled" },
  { id: "f4", round: "Group Stage", group: "F", homeTeam: "tunisia", awayTeam: "japan", date: J(20), time: "20:00", venue: "bbva", status: "scheduled" },
  { id: "f5", round: "Group Stage", group: "F", homeTeam: "japan", awayTeam: "sweden", date: J(25), time: "20:00", venue: "att", status: "scheduled" },
  { id: "f6", round: "Group Stage", group: "F", homeTeam: "tunisia", awayTeam: "netherlands", date: J(25), time: "20:00", venue: "arrowhead", status: "scheduled" },

  // --- Group G ---
  { id: "g1", round: "Group Stage", group: "G", homeTeam: "belgium", awayTeam: "egypt", date: J(15), time: "16:00", venue: "lumen", status: "scheduled" },
  { id: "g2", round: "Group Stage", group: "G", homeTeam: "iran", awayTeam: "new-zealand", date: J(15), time: "18:00", venue: "sofi", status: "scheduled" },
  { id: "g3", round: "Group Stage", group: "G", homeTeam: "belgium", awayTeam: "iran", date: J(21), time: "16:00", venue: "sofi", status: "scheduled" },
  { id: "g4", round: "Group Stage", group: "G", homeTeam: "new-zealand", awayTeam: "egypt", date: J(21), time: "19:00", venue: "bcplace", status: "scheduled" },
  { id: "g5", round: "Group Stage", group: "G", homeTeam: "egypt", awayTeam: "iran", date: J(26), time: "19:00", venue: "lumen", status: "scheduled" },
  { id: "g6", round: "Group Stage", group: "G", homeTeam: "new-zealand", awayTeam: "belgium", date: J(26), time: "19:00", venue: "bcplace", status: "scheduled" },
  ...
  { id: "h5", round: "Group Stage", group: "H", homeTeam: "cape-verde", awayTeam: "saudi-arabia", date: J(26), time: "21:00", venue: "nrg", status: "scheduled" },
  { id: "h6", round: "Group Stage", group: "H", homeTeam: "uruguay", awayTeam: "spain", date: J(26), time: "20:00", venue: "akron", status: "scheduled" },
  ...
  // --- Group J ---
  { id: "j1", round: "Group Stage", group: "J", homeTeam: "argentina", awayTeam: "algeria", date: J(16), time: "20:00", venue: "arrowhead", status: "scheduled" },
  { id: "j2", round: "Group Stage", group: "J", homeTeam: "austria", awayTeam: "jordan", date: J(16), time: "20:00", venue: "levis", status: "scheduled" },
  { id: "j3", round: "Group Stage", group: "J", homeTeam: "argentina", awayTeam: "austria", date: J(22), time: "14:00", venue: "att", status: "scheduled" },
  { id: "j4", round: "Group Stage", group: "J", homeTeam: "jordan", awayTeam: "algeria", date: J(22), time: "20:00", venue: "levis", status: "scheduled" },
  { id: "j5", round: "Group Stage", group: "J", homeTeam: "algeria", awayTeam: "austria", date: J(27), time: "19:00", venue: "arrowhead", status: "scheduled" },
  { id: "j6", round: "Group Stage", group: "J", homeTeam: "jordan", awayTeam: "argentina", date: J(27), time: "19:00", venue: "att", status: "scheduled" },

  // --- Group K ---
  { id: "k1", round: "Group Stage", group: "K", homeTeam: "portugal", awayTeam: "dr-congo", date: J(17), time: "14:00", venue: "nrg", status: "scheduled" },
  { id: "k2", round: "Group Stage", group: "K", homeTeam: "uzbekistan", awayTeam: "colombia", date: J(17), time: "20:00", venue: "azteca", status: "scheduled" },
  { id: "k3", round: "Group Stage", group: "K", homeTeam: "portugal", awayTeam: "uzbekistan", date: J(23), time: "13:00", venue: "akron", status: "scheduled" },
  { id: "k4", round: "Group Stage", group: "K", homeTeam: "colombia", awayTeam: "dr-congo", date: J(23), time: "20:00", venue: "akron", status: "scheduled" },
  ...
  // --- Group L ---
  { id: "l1", round: "Group Stage", group: "L", homeTeam: "england", awayTeam: "croatia", date: J(17), time: "17:00", venue: "att", status: "scheduled" },
